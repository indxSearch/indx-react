...
export const ICON_NAMES = [
  ...
  "Chevron_left", "Chevron_right", "Chevron_up", "Circle", "Clock", "Cloud", "Cmd", "Code", "Coffee", "Coins",
  ...
  "Fish_hooked", "Fishing_net", "Fishing_rod", "Flag", "Flower", "Folder", "Four_leaf_clover", "Frost", "Gas_station_ev_charger",
  ...
  "Search_query", "Shield", "Shift", "Slack", "Sliders_horizontal", "Sliders_vertical", "Smaller", "Smaller_or_equal", "Smile",
  "Snowmobile", "Sort_ascending", "Sort_descending", "Spark", "Special_characters", "Spectrum", "Spectrum_flat", "Speedometer",
  "Status", "Stop", "String", "Sunrise", "Support", "Tag", "Terminal", "Text_cursor", "Thumbs_up", "Tobacco_pipe", "Tool_box",
  ...
  "Volume_low", "Volume_medium", "Volume_mute", "Warning", "Weber_grill", "Weight", "Weight_high", "Weight_low", "Weight_medium",
  "WiFi", "X_or_error", "Zap",
];
